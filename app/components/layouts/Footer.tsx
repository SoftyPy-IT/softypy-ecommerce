    ...
    <footer className="bg-linear-to-br from-[#D2E9D9] to-[#B8DBC4] relative overflow-hidden">
      ...
      <Container className="px-4 py-12 2xl:px-0 relative z-10">
            ...
            <div className="pt-4">
              ...
              <div className="flex gap-2">
                <input
                  ...
                  className="flex-1 px-3 py-2 text-sm rounded-lg bg-white/80 backdrop-blur-sm border border-gray-300 focus:outline-none focus:ring-2 focus:ring-purple-600 focus:border-transparent transition-all"
                />
                <button className="px-4 py-2 bg-purple-600 text-white text-sm font-medium rounded-lg hover:bg-purple-700 transition-colors duration-200 hover:shadow-lg">
                  Subscribe
                </button>
              </div>
            </div>
        ...
        <button
          ...
          className="absolute bottom-8 right-8 bg-purple-600 text-white p-3 rounded-full shadow-lg hover:bg-purple-700 hover:scale-110 transition-all duration-300 hidden md:block"
