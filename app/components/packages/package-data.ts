...
export const plans: Plan[] = [
  {
    ...
    features: [
      ...
      { text: "কাস্টম ডোমেইন সেটআপ", included: true },
      ...
      { text: "SEO ফিচারসমূহ", included: true },
      ...
      { text: "খরচ ম্যানেজমেন্ট সিস্টেম", included: false },
      { text: "সেলস টার্গেট ম্যানেজমেন্ট", included: false },
      { text: "অর্ডার অ্যাক্টিভিটি লগস", included: false },
      { text: "ইউজার নোটিফিকেশন কন্ট্রোল", included: false },
    ],
  },
